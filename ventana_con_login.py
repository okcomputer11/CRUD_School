...
class Ventana_root():
    ...
    estudiantes = Alumnos()
                            # dentro de alumnos_ORM
                            # class Alumnos:
                            # //
                            #   def recupera_alumnnos(self, tabla_recibida):
                            # //
                            #   @DecoradorLoggeo
                            #   def alta(self, dni, class_division, first_name, last_name, day_birth,
                            #           status, sexo, address, line_phone, movile_phone1, movile_phone2):
                            # //
                            #   @DecoradorLoggeo
                            #   def baja(self,register):
                            # //
                            #   @DecoradorLoggeo
                            #   def modificacion(self, id, get_dni, get_class_division, get_first_name,
                            #                   get_last_name, get_day_birth, get_status, get_sexo, get_address,
                            #                   get_line_phone, get_movile_phone1, get_movile_phone2):
        
    def __init__(self, window, user):

        logear(user.name) # --> esta función está dentro de alumnos_ORM, guarda en un .csv el usuario logeado

        self.root = window
        # Frame
        self.root.title("Sesión a nombre de: {}".format(user.name.upper()))
        self.f = Frame(self.root)
        self.f.config(width=1230, height=620)
        self.f.pack()
    ...
    def fGuardar(self):   
        if self.register == -1:   
            # Alta o Nuevo #
            self.estudiantes.alta(self.caja_dni.get(), self.caja_class.get(), self.caja_fn.get(), self.caja_ln.get(), self.caja_birthday.get(), self.caja_status.get(), self.caja_sex.get(), self.caja_address.get(), self.caja_lphone.get(), self.caja_mphone1.get(), self.caja_mphone2.get())
            messagebox.showinfo("Nuevo Elemento", 'Elemento creado correctamente.')
        else:
            # Modificacion #
            self.estudiantes.modificacion(self.register, self.caja_dni.get(), self.caja_class.get(), self.caja_fn.get(), self.caja_ln.get(), self.caja_birthday.get(), self.caja_status.get(), self.caja_sex.get(), self.caja_address.get(), self.caja_lphone.get(), self.caja_mphone1.get(), self.caja_mphone2.get())
    ...
    def crear_widgets(self):
        ...
        largo_frame1 = 95
        frame1 = Frame(self.root, )#bg="#bfdaff")
        ...
        self.btn_salir=Button(frame1,text="Salir/Quit", command=self.root.destroy,)# highlightbackground="black", fg="yellow")
        ...
        frame2 = Frame(self.root,) #bg="white" ) # o highlightbackground
        ...
        frame3 = Frame(self.root,background="brown")
